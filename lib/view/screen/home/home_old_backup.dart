...
// //                   child: Padding(
// //                     padding: const EdgeInsets.only(left: 10),
// //                     child: Text('Top Menu', style: TextStyle(color: Colors.black, fontSize: 15,fontWeight: FontWeight.bold),),
// //                   )
// //               ),
// //             ),
// //             SizedBox(
// //               height: size.height*0.01,
// //             ),
// // // https://github.com/junaid4jd/food_order_app_flutter.git
// // //             git commit -m "third commit"
// // //             git branch -M main
// // //             git remote add origin https://github.com/junaid4jd/food_order_app_flutter.git
// // //             git push -f origin main
// //
// //
// //         product == 'no' && noProducts == 'no'  ?
// //
// //         Container(
// //
// //           child: Center(
// //             child: Text('No products found in this restaurant.', style: TextStyle(color: Colors.black,
// //                 fontSize: 12
// //             ),),
// //           ),
// //
...
// //                             boxShadow: [
// //                               BoxShadow(
// //                                   color: Colors.black26, offset: Offset(0, 4), blurRadius: 5.0,spreadRadius: 1)
// //                             ],
// //                             borderRadius: BorderRadius.circular(10)
// //                         ),
// //                         child: Padding(
...
// //                   return
// //
// //                         categoriesProductsList[index].restaurantId.toString() == restaurantId.toString()
// //                             ?
// //                     GestureDetector(
// //                     onTap: () {
// //                       Navigator.push(
// //                           context,
// //                           MaterialPageRoute(builder: (context) => ProductDetailScreen(product: categoriesProductsList[index])));
// //                     },
// //                     child: Padding(
// //                       padding: const EdgeInsets.all(8.0),
// //                       child: Container(
...
// //                                       child: Text(categoriesProductsList[index].name.toString() ,
// //                                         overflow: TextOverflow.ellipsis,
// //                                         style: TextStyle(color: Color(0xFF585858), fontSize: 14,fontWeight: FontWeight.bold),),
// //                                     ),
// //                                     Container(
// //                                       width: size.width*0.2,
// //                                       child: Text('R ${categoriesProductsList[index].price.toString()}',
// //                                         overflow: TextOverflow.ellipsis,
...
// //                               Container(
// //                                 width: size.width*0.7,
// //                                 child: Text(categoriesProductsList[index].description.toString(),
// //                                   overflow: TextOverflow.ellipsis,
