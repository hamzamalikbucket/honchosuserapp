...
import 'package:figma_new_project/view/screen/googleMap/features/uber_map_feature/data/models/uber_map_direction_model.dart';
import 'package:figma_new_project/view/screen/googleMap/features/uber_map_feature/data/models/uber_map_drivers_model.dart';
import 'package:figma_new_project/view/screen/googleMap/features/uber_map_feature/data/models/uber_map_prediction_model.dart';
...
class UberMapDataSourceImpl extends UberMapDataSource {
  ...
  Future<PredictionsList> getUberMapPrediction(String placeName) async {
    ...
    //final autoCompleteUrl= "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$name&types=establishment&location=-28.4793,24.6727&radius=500&key=AIzaSyBAjePmdqb4OLKiXkOiMv9ImMCw-riRek4";

    final autoCompleteUrl = Uri.https(
        baseUrl,
        '/maps/api/place/autocomplete/json',
        {'input': placeName, 'types': 'geocode',
          'key': 'AIzaSyBAjePmdqb4OLKiXkOiMv9ImMCw-riRek4'
          //'key': 'AIzaSyDT2jOXq4VDp9DluoLKbX5d_loZSKwr5V0'
    ...
    //     baseUrl,
    //     '/maps/api/place/autocomplete/json',
    //     {'input': placeName, 'types': 'geocode', 'location': '-28.4793,24.6727','key': 'AIzaSyBAjePmdqb4OLKiXkOiMv9ImMCw-riRek4'});
    ...
    if (response.statusCode == 200) {
      ...
      print('we are in 200 getUberMapPrediction ${response.body.toString()}');
