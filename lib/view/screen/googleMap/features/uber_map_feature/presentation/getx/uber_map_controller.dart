...
import 'package:figma_new_project/view/screen/googleMap/features/uber_trips_history_feature/presentation/pages/uber_trips_history_page.dart';
...
class UberMapController extends GetxController {
  ...
  getPredictions(String placeName, String predictiontype) async {
    print("we are in get perdictions");
    ...
    if (placeName != sourcePlaceName.value ||
      ...
      print("$placeName $predictiontype placeName123");
      final predictionData = await uberMapPredictionUsecase.call(placeName);
      print(predictionData.toList().toString() + " Data is here");
  ...
  setPlaceAndGetLocationDeatailsAndDirection(
    ...
    print('userAddress we are in fun else');
      availableDriversList.clear();
      ...
      print('$sourcePlace userAddress');
      prefs.setString('userAddress', sourcePlace.toString());
      prefs.setDouble('lat', sourceLocations[0].latitude);
      prefs.setDouble('long',sourceLocations[0].longitude);
      print(sourceLocations[0].latitude.toString() + ' lathfgb');
      print(sourceLocations[0].longitude.toString() + ' longjebcje');
      addMarkers(
